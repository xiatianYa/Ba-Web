...
const model = defineModel<Api.UserManage.UserSearchParams>('model', { required: true });

type RuleKey = Extract<keyof Api.UserManage.UserSearchParams, 'userEmail' | 'userPhone'>;
